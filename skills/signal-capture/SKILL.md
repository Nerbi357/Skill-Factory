...
**Номер сквозной по файлу** — следующий за последним занятым. Разобранные записи
уходят, номера за ними не возвращаются: разбор ссылается на запись номером, и
переиспользованный номер сделает две ссылки на разное неотличимыми.
