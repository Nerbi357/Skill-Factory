...
Рабочие и стартовые промпты, технические цифры, процедуры и инструкции агенту
...
**«How to maintain»** — для автора проекта: подробно, что нужно делать, чтобы
проект обновлялся и оставался работоспособным. **Любое идейное изменение,
