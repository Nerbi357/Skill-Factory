...
Что: пять эвристик из `PROJECT_PHILOSOPHY.md` §6 — предпочитай обобщающее;
переписывай правило, а не оговаривай; сливай, а не добавляй; объясняй почему;
длина это цена — вынесенные в собственный скилл.
Зачем: это метод, а метод по закону §2 живёт в скилле, а не в конституции и не
внутри агента. Сейчас он лежит в философии потому, что нужен всем, кто судит
правку — и агенту, и сессии, и владельцу, — а подходящего скилла ещё нет.
Откуда: разговор 2026-08-07 о том, стоит ли ужать §6 и перенести подробности в
`skill-master`. Перенос в агента отвергнут: он спрятал бы метод от всех, кроме
одного потребителя.
