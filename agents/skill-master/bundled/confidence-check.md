<!-- ШТАМПОВАННАЯ КОПИЯ — не править.
     Источник:  skills/confidence-check/SKILL.md
     Снято:     2026-09-13
...
**Оставляет за скобками:** «как вести исследование» · «что из него заключать» ·
«как оформлять отчёт» — это отдельные работы · «сделана ли работа и чем это
доказано» — здесь судят утверждение о мире, а не о собственной работе. Скилл
применяется к одному утверждению за раз, везде, где утверждения делаются.
...
что никогда не было верным. Пометка стоит трёх слов.
...
**Проверь прежде, чем строить на этом довод**, а если довод о поведении
инструмента или платформы — прочитай документацию до того, как он построен, а не
после. Построить аргумент на вспомненной конкретике хуже, чем назвать её саму по
себе, потому что рассуждение вокруг делает её похожей на изученную.
...
**Правило судит заявленный факт, а не образец формы.** Цифра внутри предложения,
показанного как пример того, *как* сказать, ни о чём в мире не заявляет, и
сослаться на неё нельзя; проставить ей дату значило бы выдумать конкретику, что
запрещено выше и сильнее. Проверка: убери цифру — исчезнет факт или исчезнет
иллюстрация.
