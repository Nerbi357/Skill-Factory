...
PAIRS = {
    ...
    "ссылка называет свой файл": [
        ("PROJECT_PHILOSOPHY_CHECK.md", "Перекрёстная ссылка называет свой файл, каждый раз."),
        ("PROJECT_PHILOSOPHY_CHECK.md", "На номер раздела чужого файла не ссылаются вовсе — называют правило словами."),
