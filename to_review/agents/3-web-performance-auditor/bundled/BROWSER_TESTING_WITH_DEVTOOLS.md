<!-- STAMPED COPY — do not edit.
     Source:      addyosmani/agent-skills, skills/browser-testing-with-devtools/SKILL.md
     Taken:       2026-07-28
     Why bundled: web-performance-auditor leans on this; the folder has to work when sent alone.
-->
