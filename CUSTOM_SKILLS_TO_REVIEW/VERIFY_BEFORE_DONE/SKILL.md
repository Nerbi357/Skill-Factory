...
> `CONFIDENCE_CHECK` and a future skill about phases, and that boundary needs his
...
**Leaves out:** how confidently a *fact* is stated — that is `CONFIDENCE_CHECK`,
...
Named for the first wave and deliberately held back: it overlaps `CONFIDENCE_CHECK`
